...
namespace LidyaPos\Page\Http\Controllers;
...
use LidyaPos\Base\Traits\HasDeleteManyItemsTrait;
use LidyaPos\Page\Forms\PageForm;
use LidyaPos\Page\Http\Requests\PageRequest;
use LidyaPos\Page\Repositories\Interfaces\PageInterface;
use LidyaPos\Page\Tables\PageTable;
use Exception;
